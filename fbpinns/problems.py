...
class FDTD3D(Problem):
    ...
    #
    #     # 矩形区域
    #     def rectangle_transition(x, y, center, half_width, half_height):
    #         left = center[0] - half_width
    #         right = center[0] + half_width
    #         bottom = center[1] - half_height
    #         top = center[1] + half_height
    #
    #         inside_rectangle = (x >= left) & (x <= right) & (y >= bottom) & (y <= top)
    #         return inside_rectangle
    #
    #     # 三角形区域
    #     def triangle_transition(x, y, center, side_length):
    #         # 计算等边三角形的三个顶点
    #         height = (jnp.sqrt(3) / 2) * side_length
    #         vertices = jnp.array([
    #             [center[0], center[1] + 2 * height / 3],
    ...
    #     rectangle_c = rectangle_transition(x, y, rectangle_center, rectangle_half_width, rectangle_half_height)
    #     triangle_c = triangle_transition(x, y, triangle_center, triangle_side_length)
    #
    #     # 将在任何形状内的区域设为 2
