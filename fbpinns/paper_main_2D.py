...
import problems
from active_schedulers import AllActiveSchedulerND, PointActiveSchedulerND, LineActiveSchedulerND, \
...
# P = problems.FDTD1D()
# subdomain_xs = subdomain_xs = [np.array([-10, -3.33, 3.33, 10]), np.array([0, 2.5, 5, 7.5, 10])]
# boundary_n = (0.5,)
# y_n = (0, 1)
# batch_size = (120, 60)
...
if __name__ == "__main__":  # required for multiprocessing
    ...
    # run.train()
    ct, FBPINNTrainert = runs[0]
    run = FBPINNTrainert(ct)  # train PINN
    run.train()
