...
@_to_numpy
def plot_3D_PINN(x_batch_test, u_exact, u_test, u_raw_test, x_batch, all_params, i, n_test, losses):
    ...
    # iterations = [entry[0] for entry in losses]
    # l1_values = [entry[-1] for entry in losses]  # 注意：-2 是因为 L1 损失在元组中的位置
