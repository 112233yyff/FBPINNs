...
class Constants(ConstantsBase):
    ...
    def __init__(self, **kwargs):
        ...
        # # Define domain
        # self.SUBDOMAIN_XS = [np.array([-1, -0.33, 0.33, 1]),
        #                      np.array([-1, -0.33, 0.33, 1]), np.array([0, 0.5, 1])]
        # # Define normalisation parameters
        # self.BOUNDARY_N = (0.2,)  # sd
        # self.Y_N =  (0,1)  # mu, sd
        # # GPU parameters
        ...
        # self.SUMMARY_FREQ = 500
        # self.TEST_FREQ = 5000
        # self.MODEL_SAVE_FREQ = 2000
